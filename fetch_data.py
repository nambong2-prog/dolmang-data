...
def filter_items(all_items):
    ...
    for item in all_items:
        ...
        elif item.get("gds_lclsf_cd","") == "09" and vrty_nm in HOBAK_VARIETIES and any(j in plor_nm for j in JEJU_ORIGINS):
...
trend = update_trend(trend, "mangam",  mangam_snap,  today, mangam_stats["auction"]["daily_report"],  mangam_stats["auction"]["market_top6"])
trend = update_trend(trend, "gamgyul", gamgyul_snap, today, gamgyul_stats["auction"]["daily_report"], gamgyul_stats["auction"]["market_top6"])
trend = update_trend(trend, "hobak",   hobak_snap,   today, hobak_stats["auction"]["daily_report"],   hobak_stats["auction"]["market_top6"])
